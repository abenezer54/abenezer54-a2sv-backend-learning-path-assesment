...
func InitializeDepenencies() (uc *user_controller.UserController, lc *loan_controller.LoanController, env *bootstrap.Env) {
	app := bootstrap.App()
	...
	return userController, loanController, env
